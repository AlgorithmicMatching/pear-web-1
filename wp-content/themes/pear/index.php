  ...
  <div class="landing-about mt96">
    ...
    <div class="row mt96 mb96 pl24 pr24 about-subsection-container">
      <div class="col-xs-12 col-sm-4 about-subsection">
        ...
        <hr/>
        Besides helping you making new friends, we want to improve your knowledge about what you like and what others
        think about you.
      </div>
      <div class="col-xs-12 col-sm-4 about-subsection pr24">
        <a href="<?php echo get_template_directory_uri() ?>/dist/files/Pear Attractiveness Report.pdf" target="_blank">
          <div class="button green shadow text-uppercase button-join button-pear-report">
            <img src="<?= $path ?>/dist/images/report-icon.svg"/> The pear report
          </div>
        </a>
        <hr/>
        Periodically, we will provide you with an individual report that will inform you of your own tastes and of how
        you score with people of the other sex.
      </div>
      <div class="col-xs-12 col-sm-4 about-subsection pr24">
        <h2 class="text-uppercase text-center">Support us</h2>
        <hr/>
        Pear is free but please note, our individual reports will be made available to those with a premium membership.
        We value you using our product but we would also love your support.
      </div>
    </div>
  ...
  <div class="blog container">
    <div class="posts-container pb40">
      ...
      <div class="social-media-section mt32 mb32">
        ...
        <a target="_blank" href="https://www.facebook.com/pearmeapp/" class="icon facebook-icon"></a>
